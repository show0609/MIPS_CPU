...
HD_PWD='C:/Users/we/Desktop/COLAB3-2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench2.tcl
