   ...
   if(rst) begin
		...
		RD 	<=5'b0;
   		...
   		case( IR[31:26] )
			...
			6'd35: begin// lw   //¼g¤§«e¥ý¬Ý¸Ó«ü¥O®æ¦¡¤Î°T¸¹½u­þ¨Ç¸Ó¥´¶}­þ¨Ç¸ÓÃö³¬¡Ainput A¦b¤W­z¤w¸g³]©w¦n¤F¡A¨ºÁÙ»Ý­n³]©w¤°»ò? for example:
			...
			6'd43: begin// sw  //¨ä¹ê°µªk³£«Ü¹p¦P¡A½T»{¦n«ü¥O®æ¦¡¤Î°T¸¹½u§Y¥i
				B 		<= { { 16{IR[15]} } , IR[15:0] }; 
				MemtoReg<= 1'b1;
				RegWrite<= 1'b0;
				MemRead <= 1'b0;
